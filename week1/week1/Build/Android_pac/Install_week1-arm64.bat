...
%ADB% %DEVICE% install week1-arm64.apk
@if "%ERRORLEVEL%" NEQ "0" goto Error
%ADB% %DEVICE% shell pm list packages com.Atr1eus.week1
...
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.Atr1eus.week1
...
%ADB% %DEVICE% shell pm grant com.Atr1eus.week1 android.permission.READ_EXTERNAL_STORAGE >nul 2>&1
%ADB% %DEVICE% shell pm grant com.Atr1eus.week1 android.permission.WRITE_EXTERNAL_STORAGE >nul 2>&1
